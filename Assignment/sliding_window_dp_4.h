...
static int t_status[MAX_SEQ];           // Frames in Transmitter Window
static int r_status[MAX_SEQ];           // Status of Frames in Receiver Window
static int routing_table[5][5] = {{0, 1, 2, 2, 2}, {1, 0, 2, 2, 2}, {1, 2, 0, 3, 3}, {1, 1, 1, 0, 2}, {1, 1, 1, 1, 0}};
static FRAME t_window[MAX_SEQ];     // Transmitter Window
